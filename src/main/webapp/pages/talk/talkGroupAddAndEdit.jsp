...
function submitForm(el){
	if($("#editTab").form("validate")){
		...
		MsgUtil.loading();
		var subUrl = contextPath+"/rest/talk/talkGroup/create";
		if(data.groupUuid){//todo  判断主键是否有值(记得把主键放在form里,type=hidden)
			subUrl = contextPath+"/rest/talk/talkGroup/update";
		}
