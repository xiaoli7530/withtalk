...
var _887=$.extend({},_879(["text","ctfilebox","textbox","passwordbox","filebox","numberbox","numberspinner","combobox","combotree","combogrid","combotreegrid","datebox","datetimebox","timespinner","datetimespinner"]),{textarea:{init:function(_888,_889){
...
//add by dalinpeng
cc.push("<span title='"+(StringUtil.delHtmlTag(_8e8))+"'>");
cc.push(_8e8);
cc.push("</span>");
}
}
